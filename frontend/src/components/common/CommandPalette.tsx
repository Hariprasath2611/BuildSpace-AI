...
export default function CommandPalette() {
  ...
  const commands = [
    ...
    { name: "Go to Client Portal", action: () => { navigate('/client'); setOpen(false); }, icon: FolderGit2, type: "nav" },
    { name: "Go to Contractor Portal", action: () => { navigate('/contractor'); setOpen(false); }, icon: FolderGit2, type: "nav" },
    { name: "Go to GIS Maps", action: () => { navigate('/gis'); setOpen(false); }, icon: FolderGit2, type: "nav" },
    { name: "Go to Document Center", action: () => { navigate('/documents'); setOpen(false); }, icon: FolderGit2, type: "nav" },
    { name: "Go to Media Gallery", action: () => { navigate('/media'); setOpen(false); }, icon: FolderGit2, type: "nav" },
